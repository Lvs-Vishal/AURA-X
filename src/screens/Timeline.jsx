...
export default function Timeline() {
  const [selectedEvent, setSelectedEvent] = useState(mockTimeline[3]);
      ...
      <div className="flex flex-col gap-8 relative">
        ...
        <div className=" relative pl-4 ">
          ...
          <div className="space-y-8">
            {mockTimeline.map((ev, idx) => (
              ...
              >
                <div className="font-mono text-[0.9375rem] text-text-secondary w-12 pt-0.5">{ev.time}</div>
        ...
        <div className="">
          <Card className="p-6 p-6 bg-surface-raised border-hairline sticky top-8">
            ...
            {selectedEvent.factors.length > 0 ? (
